...
import { ModalDocumentsKanchenjunga, ModalDocumentsScholarship } from "../Modals/ModalDocuments";
import {
...
const Kanchenjunga = () => {
	...
	const { data, isLoading, isError, error, refetch } = useGetAllKanchenungaDocsQuery(
		{}
	);
	const [
		deleteSchol,
